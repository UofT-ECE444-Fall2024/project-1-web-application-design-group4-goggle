...
const SearchSidebar: React.FC<SearchSidebarProps> = ({ filters, setFilters, sort, setSort, onLocationChange, onPriceChange }) => {
                ...
                <div className="flex flex-col border border-solid border-gray-300 bg-white shadow-lg h-full">
                    ...
                    <ParentDropDown isOpen={filterByOpen} onToggle={() => setFilterByOpen(!filterByOpen)} text={"Filter by"}>
                        ...
                        <LocationFilter
                            ...
                            checkboxes={filters.location.reduce((acc: Record<string, boolean>, loc: string | number) => {
                                acc[loc] = true;
                                return acc;
                            }, {})}
                            onCheckboxChange={onLocationChange} // Handle location checkbox change
                        />
                    </ParentDropDown>
